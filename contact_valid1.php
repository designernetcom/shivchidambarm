...
if($error=="")
{
      ...
      //  $mail->Port = 587;                                    // TCP port to connect to
        ...
        $mail->From = 'shivchidambarind@gmail.com';
        $mail->FromName ='shivchidambarind@gmail.com'; 
		$mail->addAddress('shivchidambarind@gmail.com'); 
       
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Shiv Chidambar Industries';
        $mail->isHTML(true);
